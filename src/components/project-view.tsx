...
import { Plus, Download, Trash2, Edit, FilePlus2, Receipt, Loader2 } from "lucide-react";
...
export default function ProjectView({ project, organization }: ProjectViewProps) {
  ...
  const handleGeneratePdf = () => {
    ...
    setTimeout(() => {
        ...
        const generateHeaderAndContent = () => {
            // Header
            doc.setFontSize(22);
        ...
        <div className="grid auto-rows-max items-start gap-4 md:gap-8 xl:col-span-1">
          <Card>
            ...
            <CardFooter className="flex-col gap-2">
              ...
              <Button
                  className="w-full"
                  disabled={!project || !organization || isGeneratingPdf}
