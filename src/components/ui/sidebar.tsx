  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "fixed inset-y-0 z-20 flex h-svh w-[--sidebar-width] flex-col border-r bg-sidebar transition-[width,left,right] ease-in-out",
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "flex-1 bg-background transition-[margin-left,margin-right] ease-in-out",
